...
--data "scope=fr:idc:certificate:* fr:idc:content-security-policy:* fr:idc:cookie-domain:* fr:idc:custom-domain:* fr:idc:esv:* fr:idc:promotion:* fr:idc:sso-cookie:*" | jq -r ".access_token")
